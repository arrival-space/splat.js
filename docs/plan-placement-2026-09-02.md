...
| 9 (economy, 2026-09-03) | Packages lose as packages (Brush −0.32, LichtFeld −0.17): the scaleReg walks opaque unsupported splats onto the minScale wall (5–25 % collapsed dots). KEEPERS on truck (3 seeds vs combo 25.664/25.674/25.463): **Brush package with scaleReg 0** +0.14/+0.04/+0.25 = +0.14 (3/3); **decay-for-reg** (opacityReg 0 + opaDecay 0.004) +0.13/+0.02/+0.21 = +0.12 (3/3). Decay strength peaks at 0.004; deadTiny −0.04; decay+opavis −0.27; both regs off +0.09 (one seed lost). Garden confirm: package −0.10, decay −0.105, decay 0.002 −0.09 → **CLOSED**, both stay opt-in arms; no default change |
| 8 (gate matrix, 2026-09-03) | Placement set vs default, 16 cells × 2: **20k wins 6 / ties 2 / loses 0** (+0.16…+0.64); **40k loses 5 of 8** (garden −0.22 seeded, train −0.55, bar360 −0.80, bicycle −0.27, playroom −0.09). Cause at the score level: relocation churn to the last iteration — relocUntil 0.9·H restores garden 40k to par (26.844 vs 26.848); minScale 1e-4 recovers 0.15 by emptying the needle wall; anisoReg 0.001 nothing. Time +10…60 %. Flip candidate: placement + relocUntil 0.9·H; truck signature runs decide the long-horizon shape |
